...
export default function ProductionActuals({ actuals, setActuals, planning, onWeekChange, items, boms, sysproTransactions, openingWipBalances, closingWipBalances, tolerances, editable = true, canAdjust = false, onAdjustPlan, onOpenOee, users = [], currentUserId, productionLine = "blowMoulding", bomStatus }) {
